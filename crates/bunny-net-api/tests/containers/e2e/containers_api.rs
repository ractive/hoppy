...
const FIXTURE_APP_OVERVIEW: &str =
    include_str!("../../../../../fixtures/containers/app_overview.json");
...
const FIXTURE_CONTAINER_GET: &str =
    include_str!("../../../../../fixtures/containers/container_get.json");
const FIXTURE_ENDPOINTS_LIST: &str =
    include_str!("../../../../../fixtures/containers/endpoints_list.json");
const FIXTURE_ENDPOINT_ADD: &str =
    include_str!("../../../../../fixtures/containers/endpoint_add.json");
const FIXTURE_VOLUMES_LIST: &str =
    include_str!("../../../../../fixtures/containers/volumes_list.json");
const FIXTURE_VOLUME_UPDATE: &str =
    include_str!("../../../../../fixtures/containers/volume_update.json");
const FIXTURE_VOLUME_DETACH: &str =
    include_str!("../../../../../fixtures/containers/volume_detach.json");
...
const FIXTURE_REGISTRY_GET: &str =
    include_str!("../../../../../fixtures/containers/registry_get.json");
const FIXTURE_REGISTRY_ADD: &str =
    include_str!("../../../../../fixtures/containers/registry_add.json");
...
const FIXTURE_IMAGE_DIGEST: &str =
    include_str!("../../../../../fixtures/containers/image_digest.json");
...
const FIXTURE_REGIONS_LIST: &str =
    include_str!("../../../../../fixtures/containers/regions_list.json");
...
const FIXTURE_USER_LIMITS: &str =
    include_str!("../../../../../fixtures/containers/user_limits.json");
...
async fn add_endpoint() {
    ...
    use bunny_net_api::containers::ContainerPortMappingRequest;
...
async fn delete_registry() {
    ...
    use bunny_net_api::containers::RemoveContainerRegistryStatus;
