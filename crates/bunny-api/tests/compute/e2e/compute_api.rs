...
const FIXTURE_SCRIPTS_LIST: &str =
    include_str!("../../../../../fixtures/compute/scripts_list.json");
const FIXTURE_SCRIPT_GET: &str = include_str!("../../../../../fixtures/compute/script_get.json");
const FIXTURE_SCRIPT_CREATE: &str =
    include_str!("../../../../../fixtures/compute/script_create.json");
const FIXTURE_SCRIPT_UPDATE: &str =
    include_str!("../../../../../fixtures/compute/script_update.json");
const FIXTURE_SCRIPT_CODE_GET: &str =
    include_str!("../../../../../fixtures/compute/script_code_get.json");
const FIXTURE_RELEASES_LIST: &str =
    include_str!("../../../../../fixtures/compute/releases_list.json");
const FIXTURE_RELEASE_ACTIVE: &str =
    include_str!("../../../../../fixtures/compute/release_active.json");
const FIXTURE_VARIABLE_ADD: &str =
    include_str!("../../../../../fixtures/compute/variable_add.json");
const FIXTURE_VARIABLE_GET: &str =
    include_str!("../../../../../fixtures/compute/variable_get.json");
const FIXTURE_VARIABLE_UPDATE: &str =
    include_str!("../../../../../fixtures/compute/variable_update.json");
const FIXTURE_SECRETS_LIST: &str =
    include_str!("../../../../../fixtures/compute/secrets_list.json");
