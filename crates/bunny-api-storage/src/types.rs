...
pub struct StorageObject {
    ...
    pub length: i64,
    /// SHA-256 checksum of the file (may be absent for directories).
    #[serde(default)]
    pub checksum: Option<String>,
    /// Replication zone identifiers for this object (may be absent).
    #[serde(default)]
    ...
    #[serde(default)]
    pub server_id: i64,
    /// Internal array index (always 0 in current API responses).
    #[serde(default)]
    ...
    pub user_id: String,
    /// MIME content type of the file (empty string for directories).
    #[serde(default)]
