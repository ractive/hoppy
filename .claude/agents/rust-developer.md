...
Use ./hoppy-knowledgebase for long-term memory.

# Persistent Agent Memory

You have a persistent, file-based memory system at `/Users/james/devel/hoppy/.claude/agent-memory/rust-developer/`. This directory already exists — write to it directly with the Write tool (do not run mkdir or check for its existence).
