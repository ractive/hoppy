...
const FIXTURE_APPS_LIST: &str =
    include_str!("../crates/bunny-api-containers/tests/fixtures/apps_list.json");
const FIXTURE_APP_GET: &str =
    include_str!("../crates/bunny-api-containers/tests/fixtures/app_get.json");
const FIXTURE_APP_ADD: &str =
    include_str!("../crates/bunny-api-containers/tests/fixtures/app_add.json");
const FIXTURE_ENDPOINTS_LIST: &str =
    include_str!("../crates/bunny-api-containers/tests/fixtures/endpoints_list.json");
const FIXTURE_VOLUMES_LIST: &str =
    include_str!("../crates/bunny-api-containers/tests/fixtures/volumes_list.json");
const FIXTURE_REGISTRIES_LIST: &str =
    include_str!("../crates/bunny-api-containers/tests/fixtures/registries_list.json");
const FIXTURE_REGISTRY_GET: &str =
    include_str!("../crates/bunny-api-containers/tests/fixtures/registry_get.json");
const FIXTURE_REGIONS_LIST: &str =
    include_str!("../crates/bunny-api-containers/tests/fixtures/regions_list.json");
const FIXTURE_NODES_LIST: &str =
    include_str!("../crates/bunny-api-containers/tests/fixtures/nodes_list.json");
